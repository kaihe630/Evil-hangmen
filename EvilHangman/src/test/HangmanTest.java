...
public class HangmanTest {
    ...
    private IEvilHangmanGame currentGame;
    ...
    void setup(){
        try{
            currentGame = new EvilHangmanGame();
        }
        catch(Throwable t){
    ...
    void testEmptyFileLoad(){
        Assertions.assertThrows(EmptyDictionaryException.class, ()-> currentGame.startGame(new File(EMPTY_DICTIONARY), 4), "Failed to throw EmptyDictionaryException.");
        Assertions.assertThrows(EmptyDictionaryException.class, ()-> currentGame.startGame(new File(DICTIONARY), 1), "Failed to throw EmptyDictionaryException.");
        Assertions.assertThrows(EmptyDictionaryException.class, ()-> currentGame.startGame(new File(SMALL_DICTIONARY), 15), "Failed to throw EmptyDictionaryException.");
    }
    ...
    void testWordLength0(){
        try{
            Assertions.assertThrows(EmptyDictionaryException.class, ()-> currentGame.startGame(new File(DICTIONARY), 0), "Failed to throw EmptyDictionaryException.");
        }
        catch(Throwable e){
    ...
    void testLoadFiles(){
        try{
            currentGame.startGame(new File(DICTIONARY), 2);
            currentGame.startGame(new File(DICTIONARY), 10);
            currentGame.startGame(new File(SMALL_DICTIONARY), 10);
        }
        catch(Throwable e) {
    ...
    void testGuessAlreadyMade(){
        ...
        try{
            currentGame.makeGuess('a');
        }
        catch(Throwable e){
            fail("Making a guess threw: " + e.getClass());
        }
        Assertions.assertThrows(GuessAlreadyMadeException.class, ()-> currentGame.makeGuess('a'), "Failed to throw GuessAlreadyMadeException.");
        Assertions.assertThrows(GuessAlreadyMadeException.class, ()-> currentGame.makeGuess('A'), "Failed to throw GuessAlreadyMadeException with uppercase letter.");

        try{
            currentGame.makeGuess('E');
        }
        catch(Throwable e){
            fail("Guessing a letter after a previously guessed letter threw: " + e.getClass());
        }
        Assertions.assertThrows(GuessAlreadyMadeException.class, ()-> currentGame.makeGuess('E'), "Failed to throw GuessAlreadyMadeException with uppercase letter.");
        Assertions.assertThrows(GuessAlreadyMadeException.class, ()-> currentGame.makeGuess('a'), "Failed to throw GuessAlreadyMadeException with previously guessed letter.");
    }
    ...
    void test2LetterWord(){
        ...
        try{
             possibleWords = currentGame.makeGuess('a');
        }
        catch(Throwable e){
            fail("Making a guess threw: " + e.getClass());
        }
        ...
        try{
            possibleWords = currentGame.makeGuess('e');
        }
        catch(Throwable e){
            fail("Making a guess threw: " + e.getClass());
        }
    ...
    void test3LetterWord(){
        try {
            currentGame.startGame(new File(DICTIONARY), 3);
        } catch (IOException e) {
            fail("Start game threw IOException");
        } catch (EmptyDictionaryException e) {
            fail("Dictionary that contains words is counted as empty");
        ...
        try{
            possibleWords = currentGame.makeGuess('o');
        }
        catch(Throwable e){
            fail("Making a guess threw: " + e.getClass());
        }
        ...
        try{
            possibleWords = currentGame.makeGuess('e');
            possibleWords = currentGame.makeGuess('u');
            possibleWords = currentGame.makeGuess('i');
        }
        catch(Throwable e){
            fail("Making a guess threw: " + e.getClass());
        }
    ...
    void test10letterWord(){
        ...
        Set<String> possibleWords = new HashSet<>();
        try{
            possibleWords = currentGame.makeGuess('t');
        }
        catch(Throwable e){
            fail("Making a guess threw: " + e.getClass());
        }
        ...
        try{
            possibleWords = currentGame.makeGuess('a');
            possibleWords = currentGame.makeGuess('i');
            possibleWords = currentGame.makeGuess('r');
            possibleWords = currentGame.makeGuess('s');
        }
        catch(Throwable e){
            fail("Making a guess threw: " + e.getClass());
        }
        ...
        try{
            possibleWords = currentGame.makeGuess('u');
            possibleWords = currentGame.makeGuess('c');
            possibleWords = currentGame.makeGuess('p');
            possibleWords = currentGame.makeGuess('f');
        }
        catch(Throwable e){
            fail("Making a guess threw: " + e.getClass());
        }
    ...
    void testLargestGroup() {
        try {
            currentGame.startGame(new File(SMALL_DICTIONARY), 6);
        } catch (IOException e) {
            fail("Start game threw IOException");
        } catch (EmptyDictionaryException e) {
            fail("Dictionary that contains words is counted as empty");
        ...
        try {
            possibleWords = currentGame.makeGuess('l');
        } catch (Throwable e) {
            fail("Making a guess threw: " + e.getClass());
        }
    ...
    void testLetterDoesNotAppear() {
        try {
            currentGame.startGame(new File(SMALL_DICTIONARY), 5);
        } catch (IOException e) {
            fail("Start game threw IOException");
        } catch (EmptyDictionaryException e) {
            fail("Dictionary that contains words is counted as empty");
    ...
    void testFewestInstances() {
        try {
            currentGame.startGame(new File(SMALL_DICTIONARY), 7);
        } catch (IOException e) {
            fail("Start game threw IOException");
        } catch (EmptyDictionaryException e) {
            fail("Dictionary that contains words is counted as empty");
        ...
        Set<String> possibleWords = new HashSet<>();
        try {
            possibleWords = currentGame.makeGuess('z');
        } catch (Throwable e) {
            fail("Making a guess threw: " + e.getClass());
        }
        ...
        try {
            currentGame.startGame(new File(SMALL_DICTIONARY), 8);
        } catch (IOException e) {
            fail("Start game threw IOException");
        } catch (EmptyDictionaryException e) {
            fail("Dictionary that contains words is counted as empty");
    ...
    void testRightmostLetter() {
        try {
            currentGame.startGame(new File(SMALL_DICTIONARY), 3);
        } catch (IOException e) {
            fail("Start game threw IOException");
        } catch (EmptyDictionaryException e) {
            fail("Dictionary that contains words is counted as empty");
        ...
        try {
            currentGame.startGame(new File(SMALL_DICTIONARY), 12);
        } catch (IOException e) {
            fail("Start game threw IOException");
        } catch (EmptyDictionaryException e) {
            fail("Dictionary that contains words is counted as empty");
        ...
        possibleWords = new HashSet<>();
        try {
            possibleWords = currentGame.makeGuess('h');
        } catch (Throwable e) {
            fail("Making a guess threw: " + e.getClass());
        }
        assertEquals(2, possibleWords.size(), "Incorrect word count after 1st guess.");
    ...
    void testRightmostOfMultipleInstances(){
        try {
            currentGame.startGame(new File(SMALL_DICTIONARY), 9);
        } catch (IOException e) {
            fail("Start game threw IOException");
        } catch (EmptyDictionaryException e) {
            fail("Dictionary that contains words is counted as empty");
        ...
        Set<String> possibleWords = new HashSet<>();
        try {
            possibleWords = currentGame.makeGuess('g');
        } catch (Throwable e) {
            fail("Making a guess threw: " + e.getClass());
        }
        assertEquals(2, possibleWords.size(), "Incorrect word count after 1st guess");
